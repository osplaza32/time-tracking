...
CLIENT_SECRET_FILE = 'client_secret_90613741842-pc58qsfsc1vheguo1eupi6hifpc0l7od.apps.googleusercontent.com (1).json'
APPLICATION_NAME = 'Google Calendar API Python Quickstart'
# fin calendar
# to google drive
SCOPES2 = 'https://www.googleapis.com/auth/drive.metadata.readonly'
CLIENT_SECRET_FILE2 = 'client_secret_90613741842-pc58qsfsc1vheguo1eupi6hifpc0l7od.apps.googleusercontent.com (1).json'
APPLICATION_NAME2 = 'Drive API Python Quickstart'
# fin google driverben
# to google sheets
SCOPES3 = 'https://www.googleapis.com/auth/spreadsheets'
CLIENT_SECRET_FILE3 = 'client_secret_90613741842-pc58qsfsc1vheguo1eupi6hifpc0l7od.apps.googleusercontent.com (1).json'
...
def opendfile(id, service):
    ...
    result["values"].pop(0)
    bodytotals = initapicalendar(result["values"], mails, nameequipo)
    values = [
        [
            # Cell values ...
        ],
    ...
    Range4write = 'Hoja 1!B2'
    request = service.spreadsheets().values().update(spreadsheetId=id, range=Range4write,
...
def initapicalendar(hashcolletion, mails, names):
    ...
    hola = getEvets4UserHash(service, mails, hashcolletion)
    return hola
...
def getEvets4UserHash(service, mails, hashcolletion):
    ...
    while i < len(hashcolletion):
        # print(i)
        l.append(getEvets4User(service, mails, hashcolletion[i][0]))
        i += 1
    return l
...
def getEvets4User(service, mails, hashcolle, page_token=None):
    ...
    while i < len(mails):
        ...
        totales = usercount4hash(total, hashcolle)
        l.append(str(totales))
        total = 0
        i += 1
    return l
